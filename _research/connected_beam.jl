...
# Boundary values
pt_forces   = body_to_wind_axes.(adjacent_joiner(half_forces, half_forces), aero_state.alpha, aero_state.beta)
pt_moments  = body_to_wind_axes.(adjacent_joiner(M1s, M2s), aero_state.alpha, aero_state.beta)
