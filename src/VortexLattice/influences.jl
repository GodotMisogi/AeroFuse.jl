...
"""
influence_matrix(colpoints, normals, horseshoes :: AbstractVector{<: Horseshoe}, V_hat :: SVector{3, <: Real}, symmetry :: Bool) = [ influence_coefficient(r_i, horsie_j, n_i, V_hat, symmetry) for (r_i, n_i) ∈ zip(colpoints, normals), horsie_j ∈ horseshoes ]
...
function matrix_assembly!(AIC :: AbstractMatrix{<: Real}, boco, colpoints :: AbstractArray{<: SVector{3, <: Real}}, normals :: AbstractArray{<: SVector{3, <: Real}}, horseshoes :: AbstractVector{<: Horseshoe}, U, Ω, V_hat :: SVector{3, <: Real})
