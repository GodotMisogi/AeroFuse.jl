...
export Aircraft, Foil, arc_length, kulfan_CST, naca4, camber_CST, paneller, read_foil, split_foil, foil_camthick, camber_thickness_to_coordinates, camber_thickness, camber_thickness_to_coordinates, cosine_foil, camthick_to_CST, coords_to_CST, max_thickness_to_chord_ratio_location, # 2D setups
...
import .VortexLattice: Horseshoe, streamlines, influence_coefficient, influence_matrix, boundary_condition, quasi_steady_freestream, solve_system, transform, bound_leg, horseshoe_point, bound_leg_center, bound_leg_vector, r1, r2, points, Horseshoe, horseshoe_point, panel_velocities, nearfield_forces, nearfield_moments, nearfield_drag, evaluate_coefficients, body_to_wind_axes, body_to_stability_axes, stability_to_body_axes, wind_to_body_axes, evaluate_case,  rate_coefficient, nearfield, farfield, nearfield_coefficients, farfield_coefficients,
