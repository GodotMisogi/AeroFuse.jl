...
"""
body_to_stability_axes(force, moment, freestream :: Freestream) = body_to_stability_axes(force, freestream.α), body_to_stability_axes(stab_flip(moment), freestream.α), body_to_stability_axes(stab_flip(freestream.Ω), freestream.α)
