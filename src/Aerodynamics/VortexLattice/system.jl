...
#     far_force    = farfield_forces(Γs, horseshoes, V, α, β, rho_ref)
...
force_coefficient(force, refs :: References) = force_coefficient(force, dynamic_pressure(refs.speed, refs.density), refs.area)
moment_coefficient(moment, refs :: References) = moment_coefficient(moment, dynamic_pressure(refs.speed, refs.density), refs.area, refs.span, refs.chord)
...
surface_velocities(system :: VLMSystem) = system.reference.speed * surface_velocities(system.vortices, system.circulations, system.vortices, body_frame_velocity(system.freestream), system.freestream.omega)

surface_forces(system :: VLMSystem, ::Body) = surface_forces(system.vortices, system.circulations, system.reference.speed, body_frame_velocity(system.freestream), system.freestream.omega, system.reference.density)
