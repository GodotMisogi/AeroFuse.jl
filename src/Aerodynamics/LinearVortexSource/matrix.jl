...
linear_vortex_matrix(panels_1 :: Vector{<: AbstractPanel2D}, panels_2 :: Vector{<: AbstractPanel2D}) = two_point_matrix(linear_vortex_velocity_a, linear_vortex_velocity_b, panels_1, panels_2)
linear_source_matrix(panels_1 :: Vector{<: AbstractPanel2D}, panels_2 :: Vector{<: AbstractPanel2D}) = two_point_matrix(linear_source_velocity_a, linear_source_velocity_b, panels_1, panels_2)

kutta(panels_1 :: Vector{<: AbstractPanel2D}, panels_2 :: Vector{<: AbstractPanel2D}) = [ 1 zeros(length(panels_1) - 1)' 1 zeros(length(panels_2) - length(panels_1))' ]
source_influence_matrix(panels_1 :: Vector{<: AbstractPanel2D}, panels_2 :: Vector{<: AbstractPanel2D}) = [ linear_source_matrix(panels_1, panels_2); kutta(panels_1, panels_2) ]
vortex_influence_matrix(panels_1 :: Vector{<: AbstractPanel2D}, panels_2 :: Vector{<: AbstractPanel2D}) = [ linear_vortex_matrix(panels_1, panels_2); kutta(panels_1, panels_2) ]

# Diagonal cases
kutta(panels :: Vector{<: AbstractPanel2D}) = [ 1 zeros(length(panels) - 1)' 1 ]
source_influence_matrix(panels :: Vector{<: AbstractPanel2D}) = [ linear_source_matrix(panels, panels); kutta(panels) ]
vortex_influence_matrix(panels :: Vector{<: AbstractPanel2D}) = [ linear_vortex_matrix(panels, panels); kutta(panels) ]
