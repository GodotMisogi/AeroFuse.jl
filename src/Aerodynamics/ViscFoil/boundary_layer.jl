## Boundary layer equations using finite differences in residual form
#======================================================================#
...
mutable struct BoundaryLayer2D{T <: Real, P <: AbstractPanel2D}
    ...
    M_e         :: T
    Re_θ        :: T
    BoundaryLayer2D(p :: P, U :: T = 0., θ :: T = 0., δ_star :: T = 0., H :: T = 0., H_k :: T = 0., H_star :: T = 0., H_star_star :: T = 0., CF :: T = 0., CD :: T = 0., c_τ_EQ :: T = 0., U_s :: T = 0., M_e :: T = 0., Re_θ :: T = 0.) where {T <: Real, P <: AbstractPanel2D} = new{T,P}(p, U, θ, δ_star, H, H_k, H_star, H_star_star, CF, CD, c_τ_EQ, U_s, M_e, Re_θ)
end
...
function check_transition(bl_1 :: BoundaryLayer2D, bl_2 :: BoundaryLayer2D) end
